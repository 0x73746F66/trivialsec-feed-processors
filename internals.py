...
APP_NAME = getenv("APP_NAME", default="feed-processor-binarydefense")
...
def always_log(message: str | Exception):
    caller = getframeinfo(stack()[1][0])
    alert_type = message.__class__.__name__ if hasattr(message, '__class__') else "UnhandledError"
